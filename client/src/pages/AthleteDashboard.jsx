...
const styles = {
  ...
  joinBtnFull: { width: '100%', padding: '13px 0', fontSize: 15, fontWeight: 700, borderRadius: 10, border: 'none', background: BLUE, color: '#fff', cursor: 'pointer' },
  ...
  actionBtn: { padding: '10px 18px', fontSize: 13, fontWeight: 700, borderRadius: 8, border: 'none', background: ORANGE, color: '#fff', cursor: 'pointer', whiteSpace: 'nowrap', flexShrink: 0 },
  ...
  progressTrack: { height: 4, background: 'var(--border)', borderRadius: 4, marginBottom: 14, overflow: 'hidden' },
  progressFill: { height: '100%', background: BLUE, borderRadius: 4, transition: 'width 0.4s' },

  goalForm: { display: 'flex', flexDirection: 'column', gap: 8, background: 'var(--card-inner)', borderRadius: 10, padding: '14px 16px', marginBottom: 12, border: '1px solid var(--border)' },
  goalInput: { width: '100%', padding: '9px 12px', fontSize: 14, borderRadius: 8, border: '1px solid var(--input-border)', background: 'var(--input-bg)', color: 'var(--text)', outline: 'none', fontFamily: 'inherit', boxSizing: 'border-box' },
  ...
  cancelGoalBtn: { padding: '9px 16px', fontSize: 13, fontWeight: 600, borderRadius: 8, border: '1px solid var(--border)', background: 'none', color: 'var(--text-2)', cursor: 'pointer' },
  saveGoalBtn: { padding: '9px 18px', fontSize: 13, fontWeight: 700, borderRadius: 8, border: 'none', background: BLUE, color: '#fff', cursor: 'pointer' },
