...
const styles = {
  ...
  lockBtn: { padding: '8px 18px', fontSize: 13, fontWeight: 700, borderRadius: 10, border: `1px solid ${ORANGE}`, background: 'transparent', color: ORANGE, cursor: 'pointer', transition: 'background 0.15s, box-shadow 0.15s' },
  ...
  input: { padding: '10px 14px', fontSize: 14, borderRadius: 10, border: '1px solid var(--input-border)', background: 'var(--input-bg)', color: 'var(--text)', width: '100%', boxSizing: 'border-box', outline: 'none' },
  primaryBtn: { padding: '11px 24px', fontSize: 14, fontWeight: 700, borderRadius: 10, border: 'none', background: ORANGE, color: '#fff', cursor: 'pointer', alignSelf: 'flex-start', letterSpacing: 0.2, boxShadow: '0 2px 10px rgba(247,87,9,0.32)' },
  ...
  successBox: { background: '#e8f5e9', border: '1px solid #a5d6a7', color: '#2e7d32', borderRadius: 10, padding: '10px 14px', fontSize: 13 },
