  ...
  return (
    <div style={styles.page}>
      <div style={styles.content}>
        <img src="/Offseaz_Logo__White_Letter__Dark_PNG.png" alt="Offseaz" style={styles.logoHero} />
        {error ? (
...
const styles = {
  ...
  joinCard: {
    ...
    alignItems: 'center',
    gap: 16,
    padding: 'clamp(28px, 6vw, 40px) clamp(24px, 8vw, 60px)',
    background: 'var(--card)',
  ...
  errorCard: {
    ...
    alignItems: 'center',
    gap: 12,
    padding: 'clamp(28px, 6vw, 40px) clamp(20px, 6vw, 48px)',
    background: 'var(--card)',
    border: '1px solid var(--border)',
    borderRadius: 16,
    textAlign: 'center',
